    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
           /*  var link = param != "" ? 'http://localhost:51689/listing/listing/GetJobByToEdit?id=' + param
                ...
                var link = param != "" ? 'https://talentwebappic.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentwebappic.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
